...
namespace MFPS.Addon.Customizer
{
    ...
    public class bl_Customizer : MonoBehaviour
    {
        ...
        public bl_GunInfo GetWeaponInfo()
        {
            WeaponName = bl_CustomizerData.Instance.Weapons[WeaponID].WeaponName;
            return bl_GameData.Instance.GetWeapon(bl_CustomizerData.Instance.GetWeapon(WeaponName).GunID);
        }
